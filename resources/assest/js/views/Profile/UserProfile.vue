<template lang="">
  ...
  <div class="w-100 d-flex justify-content-center pb-30">
    <div class="d-flex flex-column w-100">
      ...
      <div class="w-100 d-flex justify-content-center">
        <div class="position-relative w-100 h-250-px">
          <img
            v-if="checkPolicy('profile_image')"
        ...
        >
          ...
          <div
            class="d-flex flex-column justify-content-around align-items-center w-100 mt-15"
          >
      ...
      <div v-if="isCurrentUser" class="w-100 mt-20 d-flex flex-row-reverse">
        <div
      ...
      <div :class="['w-100', !isCurrentUser && 'mt-30']">
        ...
        <ProfileDetail
          ...
          :userProfileProps="userProfile"
          ref="profileDetail"
          :isContact="userProfile?.user_data?.isContact"
        />
        <div
...
export default {
  ...
  watch: {
    ...
    isCurrentUser(newVal) {
      this.isCurrentUser = newVal;
    },
  },
  methods: {
     ...
     */
    checkPolicy(field) {
      const checkField = `${field}_policy`;
      return (
        this.userProfile?.user_data?.isContact ||
        this.isCurrentUser ||
        this.userProfile?.user_policy_data[checkField] === PRIVACY_POLICY.public
      );
    },
    ...
    getUserChange(user) {
      ...
      this.userProfile = {
        ...
        user_data: {
          ...
          mobile: user?.mobile ?? "",
          isContact: user?.isContact ? true : false,
        },
        user_policy_data: {
          nickname_policy:
    ...
    async getUserDetailFromProfileID() {
      ...
      try {
        ...
        this.isCurrentUser = currentUser.id === data.id;
