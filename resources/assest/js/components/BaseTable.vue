          ...
          <tr>
            <template v-for="(column, index) in columns">
              ...
              >
                <tr>
                  <td
                    class="border-top-0-px text-taupe-gray-color font-weight-600 padding"
                ...
                <template v-else v-for="type in actions" :key="type">
                  ...
                  >
                    <i
                      ...
                      "
                    />
                    <img v-else :src="getActionClass(type)" class="h-30-px" />
                  </div>
                </template>
              </div>
            </td>
...
<script>
import { DELETE_GRAY_ICON, EDIT_ICON } from "../constants/imageConst";
...
export default {
  ...
  props: {
    ...
    isHaveHeader: { type: Boolean, default: true },
  },
